...
export default function CafesPage({ onOpenProduct }) {
  return (
    <Box>
      {/* Header */}
      <Box sx={{ textAlign: 'center', px: { xs: 3, md: 10 }, pt: 7, pb: 4 }}>
        <Typography variant="h2" sx={{ fontSize: 36, mb: 1.5 }}>Nossos Cafés</Typography>
        <Typography sx={{ color: 'text.secondary', fontSize: 14, lineHeight: 1.7 }}>
          Grãos selecionados de diferentes regiões do mundo,<br />com qualidade e rastreabilidade.
        </Typography>
      </Box>
