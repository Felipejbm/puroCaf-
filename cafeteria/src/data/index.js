const cafeSerrano = new URL("../img/cafe_serrano.png",
    import.meta.url).href;
const cafeMantiqueira = new URL("../img/cafe_mantiquera.png",
    import.meta.url).href;
const cafeChapada = new URL("../img/cafe_chapada.png",
    import.meta.url).href;
const cafeMogiana = new URL("../img/cafe_mogiana.png",
    import.meta.url).href;
...
export const blogPosts = [{
        ...
        quote: "O segredo do café especial está no cuidado a cada etapa: do solo ao torrefador, cada detalhe altera a experiência.",
        sections: [{
    ...
    {
        id: 2,
        title: "Entenda as Diferentes Torras de Café",
        category: "Técnica",
        ...
        img: "../src/img/torras.png",
        author: "João Pedro",
        quote: "A torra não apenas colore o grão; ela revela camadas de aroma que podem transformar sua xícara de café.",
        sections: [{
                title: "Torra clara",
    ...
    },
    {
        ...
        author: "Ana Carolina",
        quote: "A beleza de cada bebida está na proporção entre café e leite: um pequeno ajuste muda totalmente a sensação na xícara.",
        sections: [{
    ...
    },
    {
        ...
        quote: "O café filter é sobre calma e atenção: quando cada gota cai, ela revela o sabor do grão com clareza.",
        sections: [{
                title: "Mão na massa",
    ...
    },
    {
        ...
        quote: "Quando consumido com moderação, o café é um aliado para concentração e uma rotina mais ativa.",
        sections: [{
    ...
    },
    {
        ...
        quote: "O café specialty é uma celebração da qualidade, desde a fazenda até o momento em que ele chega à sua xícara.",
        sections: [{
